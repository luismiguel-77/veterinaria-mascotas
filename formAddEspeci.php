<?php 
//VALIDAESTE CODIGO SIRVE VALIDAR SI HA INICIADO SECION O NO 
if(session_status() == PHP_SESSION_NONE)
{//SI SE HA MANTENIDO INIADO SECION 
  session_start();//start session if session not start
}
// Y SI NO MUESTRA EL MENSAJE
...
<header>
  ...
  <div class="form-busqueda">
      <h4><center>REGISTRAR NUEVO ESPECIE</center></h4> 
        <form  action="insertespecie.php" method="POST">
          <label>NOMBRE</label>
