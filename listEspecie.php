...
<header>
  ...
  <section class="container"> 
   <div class="form-busqueda">
    <h4 class="title-table">LISTA DE ESPECIES</h4>
...
<div class="table-responsive"> 
    ...
    $query =mysqli_query($con,"SELECT id_especie,nombre FROM especie");
    while($row = mysqli_fetch_array($query)){
    ?>
  <tr>
      
      <td><?php echo $row['nombre'] ?></td>
      <td><a class="btn btn-success" href="formEditEspecie.php?id_especie=<?php echo $row['id_especie'] ?>">Editar</a></td>
      <td><a class="btn btn-danger" href="deleteEspecie.php?id_especie=<?php echo $row['id_especie'] ?>">Eliminar</a></td>
  </tr>
<?php
   }  
   mysqli_close($con);
...
<br>
  <div class="btn-GN">
    <a class="btn btn-success" href="formAddEspeci.php" >NUEVO</a>
  </div>
</div>
</section>
</body>
