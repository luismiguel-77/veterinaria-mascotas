...
<header>
  ...
  <section class="container"> 
   <div class="form-b">
    <h4 class="title-table">LISTA DE CLIENTES</h4>
 ...
 <div class="table-responsive">
    ...
    $query =mysqli_query($con,"SELECT id,nombre,direccion,telefono FROM  Cliente");
  ...
  <tr>
      ...
      <td><a class="btn btn-success" href="formEditClient.php?id=<?php echo $row['id'] ?>">Editar</a></td>
      <td><a class="btn btn-danger" href="deleteClient.php?id=<?php echo $row['id'] ?>">Eliminar</a></td>
  </tr>
<?php
   }  
   mysqli_close($con);
...
<br>
  <div class="btn-GN">
    <a class="btn btn-info" href="pdf/pdfcliente.php"> VER REPORTE</a>
    <a class="btn btn-success" href="formAddClient.php" >NUEVO</a>
  </div>
</div>
</section>
</body>
